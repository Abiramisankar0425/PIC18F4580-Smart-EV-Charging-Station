# PIC18F4580-Smart-EV-Charging-Station
This project simulates an Electric Vehicle charging station with safety locks and serial telemetry output
# PIC18F4580 Smart EV Charging Station

## 💡 Overview

This project implements a **Smart Electric Vehicle (EV) Charging Station** using the **PIC18F4580 microcontroller**. The system simulates real-world EV charging infrastructure with connector locking, battery charging, UART telemetry, charging mode selection, and emergency safety shutdown.

The charging station uses a Finite State Machine (FSM) architecture to manage charging operations safely and efficiently.

---

## 🚗 Features

* EV Plug Connection Detection
* Automatic Connector Locking Mechanism
* DC Motor Controlled Plug Latch
* Normal Charging Mode (AC)
* Fast Charging Mode (DC)
* UART Telemetry Monitoring
* Real-Time Battery State of Charge Display
* LCD User Interface
* Emergency Stop System
* Automatic Connector Release After Charging
...
| PIC Pin | Function           |
| ------- | ------------------ |
| RB0     | Plug Insert Button |
| RB1     | Charge Rate Toggle |
| RB2     | Emergency Stop     |
...
| PIC Pin | Indicator                  |
| ------- | -------------------------- |
| RD4     | Green LED (Ready/Complete) |
| RD5     | Red LED (Fault)            |
| RD6     | Yellow LED (Charging)      |
| RD7     | Emergency Warning          |
...
![image alt](https://github.com/Abiramisankar0425/PIC18F4580-Smart-EV-Charging-Station/blob/7502a85ef8c51c5ba64c3040a64902c62ff6b3be/EV_charging.png)
```
![image alt](https://github.com/Abiramisankar0425/PIC18F4580-Smart-EV-Charging-Station/blob/78e1a9f5b2980fc15d9339ebc5aa0ccaf0fb99d7/output.png)
---
...
### State 1 – Connector Locking

* Motor rotates forward
* Charging plug is locked
* Charging session initialized

### State 2 – Charging

* Yellow LED flashes
* Battery SOC increases
* UART telemetry transmitted
* LCD shows charging status

### State 3 – Charge Complete

* Battery reaches 100%
* Connector unlocks automatically
* User notified to unplug vehicle

### State 4 – Emergency Stop

* Charging halted immediately
* Connector unlocked
...
Commands can be entered through the Proteus Virtual Terminal.

| Command | Function           |
| ------- | ------------------ |
| S       | Start Charging     |
| F       | Toggle Fast Charge |
| K       | Abort Charging     |
| E       | Emergency Stop     |
...
```text
==========================================
Smart EV Charging Station Online
==========================================

TX_DATA: SOC=10%, V=230V, I=32A
TX_DATA: SOC=20%, V=230V, I=32A
TX_DATA: SOC=40%, V=230V, I=32A

FAST Charge Activated

TX_DATA: SOC=60%, V=400V, I=120A
TX_DATA: SOC=80%, V=400V, I=120A
TX_DATA: SOC=100%, V=400V, I=120A

Vehicle battery fully charged!
Releasing connector plug...
```
...
Create a new project for PIC18F4580.

### 2️⃣ Add Source Code

Copy the EV charging station code into the project.
...
Compile successfully to create HEX output.

### 5️⃣ Load Into Proteus

Load HEX file into PIC18F4580.

### 6️⃣ Connect Components

Wire LCD, buttons, motor driver, LEDs and virtual terminal.
...
* Software Delay Based Timing
* Single Vehicle Charging Support
* No Real Battery Communication Protocol
...
* XC8 Compiler
* Proteus Design Suite
* UART Communication Documentation
